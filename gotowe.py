...
#dokładnosc_wyniku
        ...
        self.groupBox_dokładnosc_wyniku.setGeometry(QtCore.QRect(10, 190, 412, 32))
        ...
        self.Label_dokładnosc_wyniku.setGeometry(QtCore.QRect(40, 5 ,200 ,20 ))
        ...
        self.spinBox_dokladnosc.setGeometry(QtCore.QRect(330, 5, 42, 22))
        self.spinBox_dokladnosc.setObjectName("dokładność wyniku")
        self.spinBox_dokladnosc.setRange(0, 10)

#przycisk oblicz
        self.pushButton_oblicz = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_oblicz.setGeometry(QtCore.QRect(9, 225, 414, 23))
        self.pushButton_oblicz.setObjectName("pushButton_oblicz")
        self.pushButton_oblicz.clicked.connect(self.kalkulator)

# oknowyświetlające wynik
        self.Label_wynikft = QtWidgets.QLabel(self.centralwidget)
        self.Label_wynikft.setGeometry(QtCore.QRect(10, 255, 180, 30))
        self.Label_wynikft.setObjectName("Label_wynikft")

        self.okno_wynik= QtWidgets.QTextEdit(self.centralwidget)
        self.okno_wynik.setGeometry(70, 260, 200, 110)
        self.okno_wynik.setDisabled(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_wprowadzenie.setText(_translate("MainWindow", "Witaj w programie wyliczającym siłę tarcia. "
                                                      "Początkowo zaznacz wartości które znasz. "))
        self.pushButton_oblicz.setText(_translate("MainWindow", "Oblicz"))
        ...
        self.label_masa.setText(_translate("MainWindow", "Masa obiektu w kg"))
        self.label_kat.setText(_translate("MainWindow", "Kąt nachylenia "))
        self.Label_wynikft.setText(_translate("MainWindow", "Wyniki:"))
    ...
    def kalkulator(self):
        ...
        i= self.spinBox_dokladnosc.value()
        ...
        fz =g1*masa*salfa
        fz1 = round(fz,i)
        self.text1 = ("Siła zsuwająca",fz1, "N")
        self.text2 = ("Siłą tarcia",ft1,"N")
        self.text3 = ("Przyciąganie ziemskie",g1, "m/s^2")

        self.okno_wynik.setPlainText("Siła zsuwająca: {}N \nSiłą tarcia:{}N \nPrzyciąganie ziemskie: {}m/s^2".format(fz1, ft1, g1))
